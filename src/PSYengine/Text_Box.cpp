...
//---------------------------------------------------------------------------
void TextBox::init(int w, int h, int inL, int inR, int inT, int inB)
{
	width=w;
	height=h;
...
//---------------------------------------------------------------------------
void TextBox::FormatStrCat(const char * str) {
	char buff[MAX_STR];
	char buff2[MAX_STR];
	char * cP;
	char * cP2;
...
GLuint TextBox::fontID = 666666666;



const COLOR  TextBox::BLACK =   { 0 , 0 , 0 , 255 };
const COLOR  TextBox::GREY =    { 128 , 128 , 128 , 255 };
const COLOR  TextBox::GREEN =   { 0 , 255 , 0 , 255 };
const COLOR  TextBox::WHITE =   { 255 , 255 , 255 , 255 };
const COLOR  TextBox::YELLOW =  { 255 , 255 , 0 , 255 };
const COLOR  TextBox::BLUE =    { 0 , 0 , 255 , 255 };
const COLOR  TextBox::RED =     { 255 , 0 , 0 , 255 };
const COLOR  TextBox::MAGENTA = { 255 , 0 , 255 , 255 };
const COLOR  TextBox::CYAN =    { 0 , 255 , 255 , 255 };
